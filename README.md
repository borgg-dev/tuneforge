...
graph TB
    ...
    subgraph Miners
        M1[Miner 1<br/>MusicGen Large]
        M2[Miner 2<br/>Stable Audio/Custom]
...
**Miners** run a generation backend (MusicGen Large, Stable Audio Open, or any custom model), receive challenges via axon, and return generated audio. Higher-quality, faster generation earns more weight and TAO. The baseline models are starting points -- miners who innovate with better models earn higher scores.
...
- **Additional generation backends** -- MusicGen Large and Stable Audio Open 1.0 serve as baselines; miners are encouraged to integrate new models as they emerge
